...
scene.fog = new THREE.FogExp2('#14120F', 0.0085);

const camera = new THREE.PerspectiveCamera(55, innerWidth / innerHeight, 0.1, 400);

scene.add(new THREE.AmbientLight('#8A7E72', 0.8));
const key = new THREE.PointLight('#E8C4A0', 900, 0, 1.8);
key.position.set(18, 24, 20);
scene.add(key);
const rim = new THREE.PointLight('#7B9DB8', 500, 0, 1.8);
...
const stars = new THREE.Points(
  starGeo,
  new THREE.PointsMaterial({ color: '#5C5248', size: 0.35, transparent: true, opacity: 0.6, depthWrite: false })
);
scene.add(stars);
